...
class TrainingDashboardGI extends StatefulWidget {
  const TrainingDashboardGI({Key? key}) : super(key: key);

  @override
  State<TrainingDashboardGI> createState() => _TrainingDashboardGIState();
}

class _TrainingDashboardGIState extends State<TrainingDashboardGI> with TickerProviderStateMixin {
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
            title: Align(
              ...
              child: Text(StringUtils.generalInsurance, textAlign: TextAlign.left
                , style: Theme
                    .of(context)
                    .appBarTheme
                    .titleTextStyle,),
                            ...
                            child: PinkBorderButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) {
                                        //return const TrainingStatus(title: StringUtils.generalInsurance,);
                                        return const TrainingDays(title: StringUtils.generalInsurance,);
                                      }),
                                );
                              },),
                          ),
