                    ...
                    child: CircularPercentIndicator(
                      ...
                      center: Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 34,
                              color: widget.answerData?.result
                                  ?.toLowerCase() ==
                                  StringUtils.pass
                                  ? appTheme.trainingResultTextColor
                                  : appTheme.trainingResultFailTextColor,
                              fontFamily: "Poppins",
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                            widget.answerData?.result?.toLowerCase() ==
                                StringUtils.pass
                                ? StringUtils.trainingSuccessMessage
                        ...
                        PinkBorderButton(
                          ...
                          widget.answerData?.result?.toLowerCase() ==
                              StringUtils.pass
                              ? StringUtils.downloadCertificate
                              : StringUtils.reExam,
                          onPressed: () {
                            ...
                            decoration: ShapeDecoration(
                                ...
                                shape: RoundedRectangleBorder(
                                    ...
                                    side: BorderSide(
                                        width: 4,
                                        color: appTheme
                                            .trainingResultQueBgColor)),
                                color: appTheme.trainingResultAnsBgColor),
                            alignment: Alignment.center,
                            child: Row(
                              mainAxisAlignment:
                              MainAxisAlignment.spaceBetween,
                              children: [
                                const Text(StringUtils.totalQue,
                                    style: TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.w400)),
                                Padding(
                                  ...
                                  shape: RoundedRectangleBorder(
                                      ...
                                      side: BorderSide(
                                          ...
                                          color: appTheme
                                              .trainingResultQueBgColor)),
                                  color:
                                  appTheme.trainingResultAnsBgColor),
                              alignment: Alignment.center,
                              child: Row(
                                mainAxisAlignment:
                                MainAxisAlignment.spaceBetween,
                                children: [
                                  const Text(StringUtils.totalAns,
                                      style: TextStyle(
                                          fontSize: 20,
                                          fontWeight: FontWeight.w400)),
                                  Padding(
