...
import 'package:andapp/screen/training/training_status.dart';
...
class _TrainingDashboardLIState extends State<TrainingDashboardLI> with TickerProviderStateMixin {
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
            title: Align(
              ...
              child: Text(StringUtils.lifeInsurance, textAlign: TextAlign.left
                , style: Theme
                    .of(context)
                    .appBarTheme
                    .titleTextStyle,),
                            ...
                            child: PinkBorderButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) {
                                        return const TrainingStatus(title: StringUtils.lifeInsurance);
                                      }),
                                );
                              },),
                          ),
