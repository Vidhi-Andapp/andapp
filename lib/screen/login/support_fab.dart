  ...
  Widget composeButton() {
    return SizedBox(
      ...
      child: FloatingActionButton(
        onPressed: () {},
        tooltip: 'Compose',
        child: Center(child: SvgPicture.asset(SvgImages.iconCall,height: 20,)),
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Transform(
              origin: Offset((_translateButton?.value ?? 1) * 5,0.0),
