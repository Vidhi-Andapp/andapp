class StringUtils {
  ...
  static const String gstCertification = "GST Certification";
  ...
  static const String day1Title = "Day 1. Basics of Insurance";
  static const String day2Title = "Day 2. Categories of Insurance";
  static const String day3Title = "Day 3. Process for Insurance & Claims";
  static const String menuProfile = "Profile";
  static const String menuSupport = "Support";
  static const String menuReferral = "Referral";
  ...
  static const String trainingDay2CompleteSuccess =
      "Your 2nd Day Training was completed. Please come back tomorrow for 3rd Day Training";
  static const String trainingDay3CompleteSuccess1 =
      "You have successfully completed training module. The last step to become ";
  static const String trainingDay3CompleteSuccess2 = '"Digital Advisor"';
  static const String trainingDay3CompleteSuccess3 = " is to clear the exam";
...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <div tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="modalterms" style="font-family:'Lato-Regular'">
        
                <div class="modal-body">
                    <b class="headercss">Terms and Condition</b>
                    <br><br>
